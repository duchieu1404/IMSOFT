...
UserDA.prototype.event_getall_config_ssp_ios = async function (data, callback) {
    return await this.dbModel.query_callback_object("call event_getall_config_ssp_ios()", [], callback);
}
