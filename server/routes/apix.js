...
router.post('/event_user_send_score', function (req, res, next) {

    console.log("event_user_send_score data:", req.body);

    req.app.UserDA.event_user_send_score(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_user_send_score_multi', function (req, res, next) {

    console.log("event_user_send_score_multi data:", req.body);

    req.app.UserDA.event_user_send_score_multi(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_get_event_this_week', function (req, res, next) {

    console.log("event_get_event_this_week data:", req.body);

    req.app.UserDA.event_get_event_this_week(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_global_total_score', function (req, res, next) {

    console.log("event_rank_get_global_total_score data:", req.body);

    req.app.UserDA.event_rank_get_global_total_score(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_global_best_score', function (req, res, next) {

    console.log("event_rank_get_global_best_score data:", req.body);

    req.app.UserDA.event_rank_get_global_best_score(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_team_total_score', function (req, res, next) {

    console.log("event_rank_get_team_total_score data:", req.body);

    req.app.UserDA.event_rank_get_team_total_score(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_global_total_score_lite', function (req, res, next) {

    console.log("event_rank_get_global_total_score_lite data:", req.body);

    req.app.UserDA.event_rank_get_global_total_score_lite(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_global_best_score_lite', function (req, res, next) {

    console.log("event_rank_get_global_best_score_lite data:", req.body);

    req.app.UserDA.event_rank_get_global_best_score_lite(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_team_total_score_lite', function (req, res, next) {

    console.log("event_rank_get_team_total_score_lite data:", req.body);

    req.app.UserDA.event_rank_get_team_total_score_lite(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_rank_get_me', function (req, res, next) {

    console.log("event_rank_get_me data:", req.body);

    req.app.UserDA.event_rank_get_me(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_get_reward', function (req, res, next) {

    console.log("event_get_reward data:", req.body);

    req.app.UserDA.event_get_reward(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail"
...
router.post('/event_popup_get', function (req, res, next) {

    console.log("event_popup_get data:", req.body);

    req.app.GameDA.event_popup_get(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_popup_callback', function (req, res, next) {

    console.log("event_popup_callback data:", req.body);

    req.app.GameDA.event_popup_callback(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_popup_claim', function (req, res, next) {

    console.log("event_popup_claim data:", req.body);

    req.app.GameDA.event_popup_claim(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_ct_add_multi', function (req, res, next) 
{
    req.app.UserDA.event_ct_add_multi(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_ct_set_get_user_rest', function (req, res, next) {
    req.app.UserDA.event_ct_set_get_user_rest(req.body, function (err, data) {
        if (err || !data) 
        {
            return res.json({
                status: 1,
...
router.post('/event_ct_get_leaderboard', function (req, res, next) {
    req.app.UserDA.event_ct_get_leaderboard(req.body, function (err, data) 
    {
        if (err || !data) {
            return res.json({
                status: 1,
...
router.post('/event_ct_get_leaderboard_champions', function (req, res, next) {
    req.app.UserDA.event_ct_get_leaderboard_champions(req.body, function (err, data)
    {
        if (err || !data) {
            return res.json({
                status: 1,
...
router.post('/event_ct_get_leaderboard_champion_me', function (req, res, next) {
    req.app.UserDA.event_ct_get_leaderboard_champion_me(req.body, function (err, data)
    {
        if (err || !data) {
            return res.json({
                status: 1,
...
router.post('/event_ct_get_event_info', function (req, res, next) {
    req.app.UserDA.event_ct_get_event_info(req.body, function (err, data)
    {
        if (err || !data) {
            return res.json({
                status: 1,
...
router.post('/event_ct_get_reward', function (req, res, next) {
    req.app.UserDA.event_ct_get_reward(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_ct_set_claim_unlock', function (req, res, next) {
    req.app.UserDA.event_ct_set_claim_unlock(req.body, function (err, data) 
    {
        if (err || !data) {
            return res.json({
                status: 1,
...
router.post('/event_ct_get_reward_config', function (req, res, next) {
    req.app.UserDA.event_ct_get_reward_config(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_ct_get_reward_events', function (req, res, next) {
    req.app.UserDA.event_ct_get_reward_events(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
...
router.post('/event_ct_claim_reward_event', function (req, res, next) {
    req.app.UserDA.event_ct_claim_reward_event(req.body, function (err, data) {
        if (err || !data) {
            return res.json({
                status: 1,
                msg: "ServerMsg/api_fail",
