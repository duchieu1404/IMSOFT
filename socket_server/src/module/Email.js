...
var EmailUtil = function()
{
    ...
    this.mail_default_Options = {
        from: '"ServerWaring" <info.fishclub.online@gmail.com>', // sender address
        to: '', // list of receivers
        subject: '[ServerWaring]', // Subject line
    ...
    {
        var emailObj = {
            from:emailOption.from_email || '"ServerWaring" <info.fishclub.online@gmail.com>', // sender address
            to: emailOption.to_email||'', // list of receivers
            subject: emailOption.subject||'[ServerWaring]', // Subject line
            text: '', // plaintext body
