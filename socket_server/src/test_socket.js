...
var clientX = io.connect("http://115.84.178.157:59989");
clientX.on("test_byte_result",function(data){console.log(data)});
clientX.on("get_server_state_result",function(data){console.log(data)});

clientX.emit("get_server_state",new Int8Array());
